...
public class P4_e11_MuñozG {
    ...
    public static void main(String[] args) {
        ...
        //////////////////////////////
            ...
            for (int i = 0; i < registre.length && repeat; i++) {
                if (totOK) { //si totes les respostes han sigut correctes
                    ...
                    if (contMal < MAL_MAX) {
                        do {
                            ...
                            if (tipOK) { //si la resposta ha sigut tipus int...
                                ...
                                teclado.nextLine();//neteja memòria buffer
                                if (registre[i][POS_MES] >= DIA_MIN && registre[i][POS_MES] <= DIA_MAX) {//si compleix amb les condicions bàsiques...
                                    respOK = true;//la resposta es correcte
                                }
                                else {
                                    contMal++;//la resposta ha sigut incorrecte i augmenta el contador...
                    ...
                    if (totOK && !repeat) { //si totOk es true i repeat es false ...
                        ...
                        for (int q = 0; i < registre.length; i++) {
                            /**utilitza x com a comptador per el control de mostrar totes les dades
                            ...
                            switch (registre[q][POS_SEX]) { //evalua el valor de la array ...
                                case INF: //si es 1 ....
                            ...
                            System.out.println(registre[i][POS_ID]+"\t"+registre[i][POS_ANY]+"/"+registre[i][POS_MES]+"/"+registre[i][POS_DIA]+"\t"+"\t"+genereString +"\t"+categoriaString +"\t"+"\t"+registre[i][POS_PUNT]);
                            ...
                            if (tipOK) { //si es tipus int ...
                                ...
                                if (respOrdre == RESP_SI || respOrdre == RESP_NO) {//si respRepeat es igual a 1 o 2...
                                    ...
                                    if (respOrdre == RESP_SI) { // si respRepeat es igual a 1 ...
                                        for (int z = 0; z < registre.length; z++) { //mentres el contador o sigui mes petit que conPunt -1...
                                            for (int t = 0; t < COLUM; t++) {
                                                for (int y = z + 1; y < registre.length; y++) {//y es igual al contador x pero amb una posició per davant, mentre y sigui més petit que contador...
                                                    if (registre[z][t] < registre[y][t]) { //si la posició x es més gran que la posició y ... (Per ordenar les dades.)
